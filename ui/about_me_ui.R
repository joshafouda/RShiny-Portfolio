...
liste_tabitems <- append(liste_tabitems, list(
  tabItem(
    ...
    fluidPage(
      ...
      div(
        style = "background-image: url('images/background.jpg'); background-size: cover; background-position: center; height: 100vh; display: flex; align-items: center; justify-content: center;",
        div(
          style = "background-color: rgba(255, 255, 255, 0.8); padding: 2rem; border-radius: 10px; display: flex; flex-direction: row; align-items: center;",
          tags$img(
            src = "images/linkedin_profil.png", 
            style = "width: 150px; height: 150px; border-radius: 50%; margin-right: 2rem;"
          ),
          div(
            style = "max-width: 600px; text-align: left;",
            h2("Josué (Joshua) AFOUDA", style = "font-weight: bold; color: #2C3E50;"),
